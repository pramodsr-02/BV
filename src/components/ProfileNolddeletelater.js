        ...
        <Grid item xs={12} sm={6}>
          <div className={classes.imageGallery}>
            ...
            profilee?.privacy?.photos !== "withrequest" ? (
              ...
              <div className={classes.mat__dummyprofilepic}>
                <div className={classes.mat__dummyprofilepicholder}>
                  <AccountCircleIcon className={classes.mat__dummyprofileimg} />
                  <div
                    onClick={() =>
                      RequestPhoto(
                        profilee,
            ...
            <div className={classes.actionButtonsHolder}>
              ...
              >
                {loggedUsersData?.contactrequestssent?.indexOf(
                  profilee?.email
                ) > -1
                  ? "Contact Viewed"
                  : "View Contact"}
            ...
            >
              ...
              <DialogContent>
                <DialogContentText id="alert-dialog-description">
                  {loggedinUser?.userData?.privacy?.contactInfo ===
                  "Everyone" ? (
                    <div>
                      {profilee.privacy?.contactInfo === "Everyone" ? (
                        ...
                        <div>
                          ...
                          has has hidden contact info please request for contact
                          info
                          <a
